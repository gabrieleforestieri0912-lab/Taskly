        ...
        {STATS.map((stat, index) => {
          ...
          return (
            ...
            >
              ...
              <h3 className="font-instrument-serif text-4xl md:text-5xl text-gray-900 dark:text-white mb-1.5">
                <AnimatedNumber value={stat.value} suffix={stat.suffix} />
              </h3>
              <p className="font-cabin text-[11px] font-semibold uppercase tracking-[0.16em] text-gray-500 dark:text-gray-400">
                {stat.label}
              </p>
            </motion.div>
          );
