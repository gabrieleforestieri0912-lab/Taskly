  ...
  return (
    <div className="flex gap-6 overflow-x-auto pb-6 custom-scrollbar min-h-[500px]">
      {statuses.map((status) => {
        ...
        return (
          <div key={status.id} className="flex-1 min-w-[300px] max-w-[350px]">
                      ...
                      <CardContent className="p-4">
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex -space-x-2">
                            {item.assignee && (
                              <div className="w-6 h-6 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center border-2 border-white dark:border-gray-800">
