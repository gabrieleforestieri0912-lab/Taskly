...
export const Button = ({
  ...
  const base =
    "font-cabin rounded-xl font-semibold transition-all duration-300 flex items-center justify-center backdrop-blur-md active:scale-95 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed";
